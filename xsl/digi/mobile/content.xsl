	...
	<xsl:template match="/">
		<html lang="zh_cn">
			<head>							
				...
				<link rel="stylesheet" href="/ios/ios1.css" />
			...
			<body>
				<div id="notice" data-role="page">
					<div data-role="content" data-themes="c" align="center" style="margin-top:-20px">
						<script>
							<![CDATA[
						...
						<ul data-role="listview">
							<li data-role="null" class="ui-listview" >
								
								<fieldset class="ui-grid-a" style="position:fixed;top:10px;left:20px;z-index:100;width:90%">
									<div class="ui-block-a"><xsl:if test="//a[contains(., '下一步')]">
										<button onclick="submit(this.value);" value="submit" data-rel="dialog"><xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text>下一步<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text></button></xsl:if></div>
									<div class="ui-block-b"><xsl:if test="//a[contains(., '退回')]">
										<button   onclick="submit(this.value);" value="reject" data-rel="dialog"><xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text>退回<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text></button>
									</xsl:if></div>	   
								</fieldset>
							</li>
						</ul>
						<br/>
						<ul data-role="listview" data-inset="true" data-theme="d" style="margin-top:60px">
