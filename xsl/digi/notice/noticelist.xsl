...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="viewentry">
		<li>
			<a href="javascript:void(0)" onclick="changepage('/view/digi/noticecontent/Application/DigiFlowInfoPublish.nsf/InfoByDateView_2/{@unid}?OpenDocument&amp;login');" data-icon="arrow-r" data-iconpos="right">
