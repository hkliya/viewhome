			...
			<div data-role="content" align="center">
				...
				<div class="ui-grid-b" id="divOne" style="padding-top:1em">
                    ...
                    <div class="ui-block-b">
						<a href="javascript:void(0);" onclick="showLoading();changePageWithBridge('http://mobile.sugon.com/view/digi/messagelist/Produce/DigiFlowMobile.nsf/agGetViewData?openagent&login&0.6922244625974295&server=&dbpath=DFMessage/dfmsg_<%=request.getParameter("itcode") %>.nsf&view=vwMsgUnRdForMobile&thclass=&page=1&count=15&pageFrom=homepage')">
